...
const BLUNT_IMAGE = "[img=20]res://Sprites/Effects/BluntDecal.png[/img]"
const GLUE_IMAGE = "[img=20]res://Sprites/Effects/GlueDecal.png[/img]"
const DAMAGE_IMAGE = "[img=20]res://Sprites/Effects/DamageDecal.png[/img]"
const TECH_IMAGE = "[img=20]res://Sprites/Effects/TechDecal.png[/img]"
const WHITE_IMAGE = "[img=20]res://Sprites/Effects/WhiteDecal.png[/img]"
